          ...
          children: <Widget>[
            Positioned(
              ...
              children: <Widget>[
                ...
                Transform.translate(
                  offset: Offset.fromDirection(getRadiansFromDegree(280),degOneTranslationAnimation.value * 50),
                  child: Transform(
                ...
                Transform.translate(
                  offset: Offset.fromDirection(getRadiansFromDegree(360),degTwoTranslationAnimation.value * 50),
                  child: Transform(
                ...
                Transform.translate(
                  offset: Offset.fromDirection(getRadiansFromDegree(440),degThreeTranslationAnimation.value * 50),
                  child: Transform(
